...
-- Create left panel on the first screen
--awful.wibox({ position = "left", screen = 1, width = 85 })
...
-- {{{ Signals
-- Signal function to execute when a new client is created.
client.connect_signal("new", function (c)
   ...
   --                  text = c })
    --
    -- If a window is a child of monodevelop, put it on proper screen
    --
